...
# THIS FORK - FINE TUNING OF LLaVA v1.5 7B

- Adds fine-tuning scripts - see the [Fine tuning README](./README.finetuning.md) (QLORA training)
- Adds 'evaluate between epochs' enhancement from wandb - see [article](https://wandb.ai/byyoung3/ml-news/reports/How-to-Fine-Tune-LLaVA-on-a-Custom-Dataset--Vmlldzo2NjUwNTc1)
- Adds some missing files and detalis that the article contains, but its fork does not
